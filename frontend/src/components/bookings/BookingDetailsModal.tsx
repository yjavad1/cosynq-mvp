                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="space-y-2">
                      ...
                      {((booking.contactId && typeof booking.contactId === 'object' && (booking.contactId as any).email) || booking.customerEmail) && (
                        <div className="flex items-center">
                      ...
                      {((booking.contactId && typeof booking.contactId === 'object' && (booking.contactId as any).phone) || booking.customerPhone) && (
                        <div className="flex items-center">
                      ...
                      {(booking.contactId && typeof booking.contactId === 'object' && (booking.contactId as any).company) && (
                        <div className="flex items-center">
                          <span className="text-sm font-medium text-gray-600 w-24">Company:</span>
                          <span className="text-sm text-gray-900">{(booking.contactId as any).company}</span>
                        </div>
                      )}
                    </div>
                  </div>
                      ...
                      <div className="space-y-2">
                        <div>
                          ...
                          <span className="text-sm text-gray-900 ml-2">
                            {(booking.spaceId && typeof booking.spaceId === 'object' && (booking.spaceId as any).name) || 'Unknown Space'}
                          </span>
                        </div>
                        <div>
                          <span className="text-sm font-medium text-gray-600">Type:</span>
                          <span className="text-sm text-gray-900 ml-2">
                            {(booking.spaceId && typeof booking.spaceId === 'object' && (booking.spaceId as any).type) || 'N/A'}
                          </span>
                        </div>
                        <div className="flex items-center">
